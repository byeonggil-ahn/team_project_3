                ...
                <div class="flex">
                    <div class="flex w-25">
                        ...
                        <div class="w-100 center">
                            <a class="link" style="color: #776BFF;" href="${pageContext.request.contextPath}/">
                            	<img class="logo-img" alt="로고" src="${pageContext.request.contextPath}/static/image/team_logo.png">
                            </a>
                        </div>
                    </div>
                    <div class="center w-50">
                        ...
                        <div class="search-box">
                            <input class="search-input w-100" name="keyword" placeholder="검색어를 입력하세요.">
                    ...
                    <div class="right w-25 flex pb-10">
                        ...
                        <c:if test="${sessionScope.memberId != null}">
	                        ...
	                        <div class="me-15 center">
		                        <a class="link" href="${pageContext.request.contextPath}/member/list" title="마이페이지">
        ...
        <section class="container-1000 flex">
        	<div class="admin-menu w-20">
                <div class="flex-box flex-vertical">
                    ...
                    <div class="p-10">
                        <a href="${pageContext.request.contextPath}/admin/member/memberList" class="link">회원 관리</a>
                    </div>
                    <div class="p-10">
                        <a href="${pageContext.request.contextPath}/admin/productManage/list" class="link">상품 관리</a>
                    </div>
                    <div class="p-10">
                        <a href="${pageContext.request.contextPath}/admin/sell/list" class="link">판매 내역(미구현)</a>
                    </div>
                    <div class="p-10">
                        <a href="${pageContext.request.contextPath}/admin/mainImg/list" class="link">메인 관리(미구현)</a>
                    </div>
                    <div class="p-10">
                        <a href="${pageContext.request.contextPath}/qa/list" class="link">QnA 게시판(미구현)</a>
                    </div>
               	</div>
        	</div>